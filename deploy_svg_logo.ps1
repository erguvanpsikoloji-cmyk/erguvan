...
Write-Host "DEPLOYING NEW SVG LOGO..." -ForegroundColor Cyan

# Upload SVG
Publish-File "$sourceRoot\assets\images\logo_erguvan_new.svg" "assets/images/logo_erguvan_new.svg"

# Upload Index
Publish-File "$sourceRoot\index_simple_fix.php" "index.php"

Write-Host "SVG LOGO DEPLOYED!" -ForegroundColor Yellow
