...
// 1. BOŞANMA SÜRECİ DANIŞMANLIĞI (LİTERAL)
$bosanma_literal = "## Boşanma Süreci Danışmanlığı Nedir?\n" .
    ...
    "## Sonuç\n" .
    "Boşanma süreci; bireyler, çiftler ve çocuklar için duygusal olarak zorlayıcı, karmaşık ve çoğu zaman yıpratıcı bir dönemdir. Bu sürecin profesyonel destekle yürütülmesi, hem karar alma aşamasında hem de boşanma sonrasında ruhsal uyumun sağlanmasında büyük önem taşır. Boşanma süreci danışmanlığı; bireylerin kendilerini daha iyi tanımalarına, duygularını sağlıklı biçimde düzenlemelerine ve yeni yaşamlarına daha dengeli bir şekilde adapte olmalarına yardımcı olur. Çocukların bu süreçten en az zarar görmesi, ebeveynlerin bilinçli tutumları ve çocuklara yönelik psikolojik destekle mümkündür. Çocuk psikoloğu, ergen psikoloğu ve pedagog desteği sayesinde çocukların yaşadıkları duygusal tepkiler anlaşılır ve uzun vadeli sorunların önüne geçilebilir. Fatih, Çapa ve İstanbul genelinde boşanma süreci danışmanlığı, bireysel terapi ve çocuklara yönelik psikolojik destek arayışında olan danışanlarımıza; Erguvan Psikoloji bünyesinde alanında uzman psikologlar ile profesyonel, etik ve gizlilik esasına dayalı bir destek sunmaktayız.\n\n" .
    "✍️ Uzm. Psk. Sedat Parmaksız Notu: Bu içerik bilgilendirme amaçlıdır ve profesyonel tıbbi tavsiye yerine geçmez.";

// 2. OYUN TERAPİSİ (LİTERAL)
$oyun_literal = "# Çocuklar İçin Oyun Terapisi Nedir? Faydaları, Süreci ve Seanslar Hakkında Bilmeniz Gerekenler\n" .
    ...
    "# Oyun Terapisinin Bilimsel Dayanağı\n" .
    "Oyun terapisi, gelişim psikolojisi ve klinik psikoloji temelli bilimsel araştırmalarla desteklenen bir yöntemdir. Yapılan çalışmalar, oyun terapisinin çocukların duygusal düzenleme becerilerini geliştirdiğini ve psikolojik dayanıklılığı artırdığını göstermektedir.\n\n" .
...
$panik_literal = "## Panik Atak Belirtileri Nelerdir? Panik Atak Nasıl Geçer?\n" .
    ...
    "3. Çevresel Faktörler: Yoğun iş temposu, kafein ve nikotin kullanımı, uykusuzluk, uzun süreli stres.\n\n" .
    ...
    "## Sonuç\n" .
    "Panik atak, birçok yetişkinin yaşam kalitesini düşüren ancak doğru yöntemlerle tedavi edilebilen bir kaygı problemidir. Belirtileri doğru anlamak, kaçınma davranışını azaltmak ve profesyonel destek almak iyileşme sürecini hızlandırır. İstanbul Fatih Çapa psikolog arayışında olan kişiler için, Erguvan Psikolojik Danışmanlık Merkezi yetişkinlere profesyonel destek sunmaktadır.\n\n" .
...
foreach ($files as $name => $content) {
    ...
    echo "LİTERAL METİN KAYDEDİLDİ: $name\n";
}
?>