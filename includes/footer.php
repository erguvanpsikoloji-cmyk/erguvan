    ...
    <div class="container">
        <div class="footer-grid">
            <div class="footer-brand">
                ...
                <p style="color: #cbd5e0;">Akademik temelli, etik ve profesyonel psikolojik danışmanlık hizmetleri ile
                    yanınızdayız.</p>
            ...
            <div class="footer-nav">
                ...
                <ul style="list-style:none; padding:0;">
                    ...
                    <li><a href="<?php echo url('#hizmetler'); ?>"
                            style="color:#cbd5e0; text-decoration:none;">Hizmetlerimiz</a></li>
                    <li><a href="<?php echo page_url('blog.php'); ?>"
                            style="color:#cbd5e0; text-decoration:none;">Blog</a></li>
                    <li><a href="<?php echo url('#iletisim'); ?>"
                            style="color:#cbd5e0; text-decoration:none;">İletişim</a></li>
                </ul>
            </div>
            ...
            <div class="footer-contact">
                ...
                <ul style="list-style:none; padding:0;">
                    <li style="color:#cbd5e0; margin-bottom:10px;"><strong style="color:white;">Tel:</strong> <a
                            href="tel:+905511765285" style="color:#cbd5e0; text-decoration:none;">0551 176 52 85</a>
                    </li>
                    <li style="color:#cbd5e0; margin-bottom:10px;"><strong style="color:white;">Email:</strong> <a
                            href="mailto:info@erguvanpsikoloji.com"
                            style="color:#cbd5e0; text-decoration:none;">info@erguvanpsikoloji.com</a></li>
                    <li style="color:#cbd5e0;"><strong style="color:white;">Adres:</strong> Şehremini, Millet Cd. 34098
                        Fatih/İstanbul</li>
                </ul>
            </div>
        </div>
