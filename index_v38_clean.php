...
<head>
    ...
    <!-- Fonts -->
    <link rel="stylesheet" href="assets/css/style_v38.css">
...
<body>
    ...
    <nav class="navbar" id="navbar">
        <div class="container nav-container">
            <a href="#" class="logo">
                <img src="assets/images/logo_erguvan_2026.png" alt="Erguvan Psikoloji Logo">
            </a>
            <ul class="nav-links">
    ...
    <header class="hero" id="home">
        <div class="container hero-content">
            ...
            <div class="hero-image-wrapper">
                <!-- Fallback premium CSS pattern -->
                <div
                    style="width: 100%; height: 500px; background: linear-gradient(45deg, var(--primary), var(--secondary)); opacity: 0.9; display: flex; align-items: center; justify-content: center; color: white; border-radius: var(--radius-lg);">
            ...
            <div class="team-grid">
                ...
                <div class="team-card">
                    <img src="assets/images/team/sedat.jpg" alt="Uzm. Psikolog Sedat Parmaksız" class="card-img"
                        style="height: 450px; object-position: center top;">
                    <div class="card-info">
    ...
    <section class="section" id="office" style="background-color: var(--luxe-bg);">
        <div class="container">
            ...
            <div class="office-grid">
                ...
                <div class="office-card">
                    <img src="assets/images/office/ofis-2.jpg" alt="Ofisimiz 2" class="card-img"
                        style="height: 300px; width: 100%; object-fit: cover;">
                </div>
                <div class="office-card">
                    <img src="assets/images/office/ofis-3.jpg" alt="Ofisimiz 3" class="card-img"
                        style="height: 300px; width: 100%; object-fit: cover;">
                </div>
                <div class="office-card">
                    <img src="assets/images/office/ofis-4.jpg" alt="Ofisimiz 4" class="card-img"
                        style="height: 300px; width: 100%; object-fit: cover;">
                </div>
            </div>
        </div>
    ...
    <footer style="background: var(--primary); color: white; padding: 4rem 0; text-align: center;">
        <div class="container">
            ...
            <div style="display: flex; justify-content: center; gap: 2rem; margin-bottom: 3rem;">
                ...
                <a href="#" style="color: white;"><i class="fab fa-linkedin fa-2x"></i></a>
            </div>
            <p style="font-size: 0.8rem; opacity: 0.5;">© 2026 Erguvan Psikoterapi Merkezi. Tüm hakları saklıdır.</p>
        </div>
    </footer>
    ...
    <div class="floating-actions">
        ...
        <a href="tel:+905511765285" class="float-btn phone">
    ...
    <div class="floating-container">
        <a href="tel:+905511765285" class="floating-btn btn-call" title="Bizi Arayın">
