...
if (empty($team_members)) {
    $team_members = [
        [
            ...
            'image' => 'assets/images/team/sedat-parmaksiz-v2.jpg',
            'education' => "Üsküdar Üniversitesi Psikoloji Lisans\nÜsküdar Üniversitesi Klinik Psikoloji Yüksek Lisans",
        ...
        [
            ...
            'education' => "Marmara Üniversitesi Psikoloji Bölümü\nÜsküdar Üniversitesi Klinik Psikoloji Yüksek Lisans",
...
if (empty($testimonials)) {
    $testimonials = [
        [
            'name' => 'Nihat Duman',
            'comment' => 'Ceren hanıma tavsiye üzerine gittim ilgi ve alakası çok iyi. Gerçek bir pskolog arıyorsanız doğru adrestesiniz',
            'rating' => 5,
            'source' => 'Google',
        ...
        [
            'name' => 'Ayşe Yılmaz',
            'comment' => 'Erguvan Psikoloji\'yi kesinlikle tavsiye ederim. Ceren Hanım çok anlayışlı ve profesyonel. Online terapi seansları çok verimli geçti.',
            'rating' => 5,
            'source' => 'Google',
            'date_info' => '3 ay önce',
            'avatar_char' => 'A'
...
// LCP Optimizasyonu için Preload Görselini Belirle
if (!empty($sliders)) {
    // İlk slider görseli LCP adayıdır
    $preload_image = webp_url($sliders[0]['image']);

    // Eğer görsel harici link değilse (ör: https://) ve relative path ise
    // asset_url veya tam path gerekebilir mi? Header'da kontrol edeceğiz.
    // Şimdilik DB'den geldiği gibi bırakıyoruz, header'da htmlspecialchars ile basılacak.
} else {
    // Fallback image with optimized sizing
    $preload_image = "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=600&h=411&q=80&auto=format";
}
    ...
    <?php if (!empty($sliders)): ?>
                ...
                <div class="hero-slide <?php echo $index === 0 ? 'active' : ''; ?>">
                    <div class="container">
                        <div class="hero-content">
                            <div class="hero-text">
                                <<?php echo $index === 0 ? 'h1' : 'h2'; ?> class="hero-title">
                                    <?php echo htmlspecialchars($slide['title'] ?? ''); ?>
                                    <?php if (!empty($slide['subtitle'])): ?>
                                        <br><span class="highlight"><?php echo htmlspecialchars($slide['subtitle']); ?></span>
                                    <?php endif; ?>
                                ...
                                <div class="hero-buttons">
                                    <a href="<?php echo $slide['button_link'] ? htmlspecialchars($slide['button_link']) : '#randevu'; ?>"
                                        class="btn btn-primary btn-lg"
                                        aria-label="<?php echo htmlspecialchars($slide['title'] ?? 'Hizmet'); ?> için Randevu Al">
                                        <?php echo $slide['button_text'] ? htmlspecialchars($slide['button_text']) : 'Randevu Al'; ?>
                                    </a>
                                    <a href="#hakkimda" class="btn btn-secondary btn-lg"
                                        aria-label="Hakkımızda bilgi al">Hakkımızda</a>
                                </div>
                                ...
                                <div class="hero-image-wrapper">
                                    <picture>
                                        <source media="(max-width: 600px)"
                                            srcset="<?php echo webp_url($slide['image'], 'mobile'); ?>">
                                        <img src="<?php echo webp_url($slide['image']); ?>"
                                            alt="<?php echo htmlspecialchars($slide['title']); ?>"
                                            class="floating aesthetic-image" width="600" height="411"
                                            loading="<?php echo $index === 0 ? 'eager' : 'lazy'; ?>"
                                            fetchpriority="<?php echo $index === 0 ? 'high' : 'auto'; ?>" decoding="async">
                                    </picture>
                                    <div class="hero-badge">
                                        <span class="badge-icon">✓</span>
                                        <span class="badge-text">Yanınızdayız, Her Adımda</span>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <?php if (count($sliders) > 1): ?>
            <div class="slider-controls">
                <button class="slider-btn slider-prev" aria-label="Önceki Slider">
                ...
                <div class="slider-dots">
                    <?php foreach ($sliders as $index => $slide): ?>
                        <button class="slider-dot <?php echo $index === 0 ? 'active' : ''; ?>" data-slide="<?php echo $index; ?>"
                            aria-label="Slider <?php echo $index + 1; ?>"></button>
                    <?php endforeach; ?>
                </div>
                <button class="slider-btn slider-next" aria-label="Sonraki Slider">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <?php else: ?>
        ...
        <div class="container">
            <div class="hero-content">
                <div class="hero-text">
                    <h1 class="hero-title">
                        Psikolojik Desteğe <br>
                        <span class="gradient-text">Adım Atın</span>
                    </h1>
                    <p class="hero-description">
                        Profesyonel psikolojik danışmanlık ile daha mutlu ve dengeli bir yaşam için size yardımcı
                        oluyorum. Online ve yüz yüze terapi seçenekleriyle hizmetinizdeyim.
                    </p>
                    <div class="hero-buttons">
                        <a href="#randevu" class="btn btn-primary btn-lg"
                            aria-label="Psikolojik destek için randevu al">Randevu Al</a>
                        <a href="#hakkimda" class="btn btn-secondary btn-lg"
                            aria-label="Erguvan Psikoloji hakkında bilgi al">Hakkımızda</a>
                    </div>

                </div>
                <div class="hero-image">
                    <div class="hero-image-wrapper">
                        <img src="assets/images/hero-psikolojik-destek.jpg" alt="Erguvan Psikoloji"
                            class="floating aesthetic-image" width="600" height="411" loading="eager" fetchpriority="high"
                            decoding="async">
                        <div class="hero-badge">
                            <span class="badge-icon">✓</span>
                            <span class="badge-text">Yanınızdayız, Her Adımda</span>
...
<section id="hakkimda" class="about section bg-light">
    <div class="container">
        <div class="about-content">
            <div class="about-image">
                <?php
                $about_img = !empty($about_data['image']) ? $about_data['image'] : url('ofis/ofis.webp');
                ?>
                <img src="<?php echo webp_url($about_img); ?>" alt="Erguvan Psikoloji Ofisi"
                    class="rounded-image aesthetic-image" width="600" height="411" loading="lazy" decoding="async">
            </div>
            <div class="about-text">
                <h2 class="section-title">Hakkımızda – Erguvan Psikoloji Danışmanlık Merkezi | Fatih / İstanbul</h2>
                <h3 class="about-subtitle">Erguvan Psikoloji Danışmanlık Merkezi</h3>

                <!-- Kısa Giriş Metni -->
                <p class="about-description about-intro">
                    Erguvan Psikoloji Danışmanlık Merkezi, İstanbul Fatih ilçesinde; çocuk, ergen ve yetişkinlere
                    yönelik profesyonel psikolojik danışmanlık hizmetleri sunan bir merkezdir.
                </p>

                <!-- Devamını Oku Butonu -->
                <button type="button" class="btn btn-primary about-read-more-btn" id="aboutReadMoreBtn"
                    aria-expanded="false" aria-controls="aboutFullContent">
                ...
                <!-- Gizli Detaylı İçerik -->
                <div class="about-full-content" id="aboutFullContent" aria-hidden="true">
                    <?php if (!empty($about_data['content'])): ?>
                        <div class="about-description">
                            <?php echo $about_data['content']; ?>
                        </div>
                    <?php else: ?>
                        <p class="about-description">
                            Erguvan Psikoloji olarak, İstanbul Fatih’te uzman psikolog kadromuzla 10 yılı aşkın süredir
                            profesyonel psikolojik danışmanlık hizmeti sunuyoruz. Amacımız, bireylerin yaşam kalitesini
                            artırmak, zorluklarla başa çıkma becerilerini güçlendirmek ve dönüşüm süreçlerine bilimsel
                            yöntemlerle destek olmaktır.
                        </p>
                        <p class="about-description">
                            Alanında deneyimli terapistlerimiz, Bilişsel Davranışçı Terapi (BDT) başta olmak üzere kanıta
                            dayalı
                            psikoterapi yaklaşımlarını kullanarak her danışana özel bir terapi planı oluşturur. Her bireyin
                            benzersiz ihtiyaçları olduğunu biliyor ve terapi sürecini bu doğrultuda kişiye özel olarak
                            şekillendiriyoruz.
                        </p>
                        <p class="about-description">
                            Erguvan Psikoloji’de, danışanlarımız kendilerini güvenli, yargısız ve destekleyici bir ortamda
                            ifade
                            edebilir. Amacımız, psikolojik iyi oluş yolculuğunuzda size profesyonel, etik ve bütüncül bir
                            rehberlik sunmaktır.
                        </p>
                        <p class="about-description">
                            İstanbul Fatih’te güvenilir, uzman ve bilimsel yöntemlerle çalışan bir psikolog arıyorsanız,
                            Erguvan
                            Psikoloji olarak yanınızdayız.
                        </p>
                    <?php endif; ?>
                </div><!-- /about-full-content -->
            </div><!-- /about-text -->
        </div><!-- /about-content -->
    </div><!-- /container -->
</section>
        ...
        if (empty($team_members)) {
            $team_members = [
                [
                    ...
                    'approaches_title' => 'Bilimsel Yaklaşım',
                    'approaches_desc' => 'Kanıta dayalı terapötik yöntemler kullanarak etkili sonuçlar elde ediyoruz.',
                    'values_title' => 'Etik Değerler',
                    'values_desc' => 'Meslek ettiğine bağlı kalarak danışanlarımızın haklarını koruyoruz.'
                ],
                [
                    'name' => 'Uzman Psikolog Sena Ceren Parmaksız',
                    'title' => 'Uzman Klinik Psikolog',
                    ...
                    'approaches_title' => 'Şefkatli Yaklaşım',
                    'approaches_desc' => 'Çocuk ve ergenlerle güvene dayalı, sıcak bir terapötik ilişki kuruyoruz.',
                    'values_title' => 'Gelişim Odaklı',
                    'values_desc' => 'Her çocuğun benzersiz gelişim yolculuğunu destekliyoruz.'
                ]
            ];
        }
        ?>
                    ...
                    <div class="team-card">
                        <div class="team-image-wrapper">
                            <img src="<?php echo webp_url($member['image']); ?>"
                                alt="<?php echo htmlspecialchars($member['name']); ?>" class="team-image aesthetic-image"
...
<section id="ofisimiz" class="office section">
    <div class="container">
        ...
        try {
            $office_images = $db->query("SELECT * FROM office_images WHERE is_active = 1 ORDER BY display_order ASC, created_at DESC")->fetchAll();
            foreach ($office_images as &$item) {
                if (isset($item['image']))
                    $item['image'] = sanitizePath($item['image']);
            }
        ...
        <?php if (!empty($office_images)): ?>
            <div class="office-slider-wrapper">
                <button class="office-nav prev" aria-label="Önceki görsel">
                            ...
                            <div class="office-slide">
                                <div class="office-image-wrapper">
                                    <img src="<?php echo webp_url($img['image']); ?>"
                                        ...
                                        class="office-image aesthetic-image" width="600" height="400" loading="lazy"
                                        decoding="async">
                                    <?php if ($img['title']): ?>
                ...
                <button class="office-nav next" aria-label="Sonraki görsel">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <polyline points="9 18 15 12 9 6"></polyline>
                    </svg>
                </button>
                            ...
                            <div class="testimonial-slide">
                                <div class="testimonial-card">
                                    ...
                                    <div class="testimonial-badge">
                                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                            <path d="M9 12l2 2 4-4m6 2a9 0 11-18 0 9 9 0 0118 0z"></path>
                                        </svg>
