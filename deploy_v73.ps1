...
Invoke-FtpUpload -localPath "c:\Users\ceren\Desktop\erguvan son\assets\images\logo_erguvan_transparent.png" -remotePath "$base_remotepath/assets/images/logo_erguvan_transparent.png"
...
Write-Host "v73 Deployment complete (Transparent Logo Fix)."
