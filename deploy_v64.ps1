...
Upload-File -localPath "c:\Users\ceren\Desktop\erguvan son\assets\images\logo_icon_opt.webp" -remotePath "$base_remotepath/assets/images/logo_icon_opt.webp"

Write-Host "v64 Deployment complete (Logo Optimization)."
