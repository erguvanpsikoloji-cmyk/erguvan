...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($title && $image && !$error) {
        try {
            $stmt = $db->prepare("INSERT INTO sliders (title, subtitle, description, image, button_text, button_link, display_order, is_active, created_at) 
                                   VALUES (:title, :subtitle, :description, :image, :button_text, :button_link, :display_order, :is_active, NOW())");
            $stmt->execute([
                ':title' => $title,
                ':subtitle' => $subtitle,
...
<form method="POST" action="" enctype="multipart/form-data">
    ...
    <div class="form-row">
        <div class="form-group">
            ...
            <input type="text" id="button_text" name="button_text" class="form-control" placeholder="Randevu Al">
        </div>
        <div class="form-group">
            <label for="button_link">Buton Linki</label>
            <input type="text" id="button_link" name="button_link" class="form-control" placeholder="#randevu">
        </div>
    </div>
