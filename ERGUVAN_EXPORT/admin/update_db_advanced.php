<?php
/**
 * DATABASE MIGRATION: Sena Ceren Advanced Blog Features
 */
...
try {
    ...
    $columns = [
        ...
        'toc_data' => "TEXT AFTER meta_description", // Added missing toc_data column too just in case
    ...
    echo "\nİşlem başarıyla tamamlandı. Sena Hanım için gelişmiş asistan özellikleri aktif!";
