...
Write-Host "DEPLOYING OPTIMIZATIONS..." -ForegroundColor Cyan

# Upload Index (Lazy Load + Mobile Styles)
Publish-File "$sourceRoot\index_simple_fix.php" "index.php"

# Upload .htaccess (Gzip + Caching)
Publish-File "$sourceRoot\.htaccess" ".htaccess"

Write-Host "OPTIMIZATIONS DEPLOYED!" -ForegroundColor Yellow
