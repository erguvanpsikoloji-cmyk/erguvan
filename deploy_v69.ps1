...
Upload-File -localPath "c:\Users\ceren\Desktop\erguvan son\assets\images\logo_erguvan_2026.png" -remotePath "$base_remotepath/assets/images/logo_erguvan_2026.png"

Write-Host "v69 Deployment complete (Real Watercolor Logo)."
