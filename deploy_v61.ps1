...
Upload-File -localPath "c:\Users\ceren\Desktop\erguvan son\assets\images\logo_icon.webp" -remotePath "$base_remotepath/assets/images/logo_icon.webp"

Write-Host "v61 Deployment complete (Logo Optimization)."
