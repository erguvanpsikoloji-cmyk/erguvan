...
Upload-File -localPath "c:\Users\ceren\Desktop\erguvan son\assets\images\logo_icon.svg" -remotePath "$base_remotepath/assets/images/logo_icon.svg"

Write-Host "v62 Deployment complete (SVG Logo Transition)."
