...
function Upload-File {
    ...
    try {
        ...
        $response.Close()
        Write-Host "Success: Uploaded $localPath" -ForegroundColor Green
    }
    catch {
...
Upload-File -localPath "c:\Users\ceren\Desktop\erguvan son\assets\images\hero-psikolojik-destek-opt.webp" -remotePath "$base_remotepath/assets/images/hero-psikolojik-destek-opt.webp"
Upload-File -localPath "c:\Users\ceren\Desktop\erguvan son\assets\images\hero-psikolojik-destek-mobile.webp" -remotePath "$base_remotepath/assets/images/hero-psikolojik-destek-mobile.webp"
